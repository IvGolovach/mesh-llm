...
toolchain/runtime compatibility and read-only
...
evidence cannot certify. Full worker/build logs remain for 14 days; executable
handoffs remain for seven days so a single-machine queue can complete later
passes.

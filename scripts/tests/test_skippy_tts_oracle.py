...
class TtsOracleTests(unittest.TestCase):
    def test_prebuilt_candidate_requires_verified_producer_and_never_runs_cargo(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # The oracle resolves the recorded path against the manifest's
            # real (symlink-resolved) directory.
            self.assertEqual([str((root / "candidate tests").resolve()), oracle.TEST_NAME,
